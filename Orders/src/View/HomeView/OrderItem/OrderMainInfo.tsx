...
export const OrderMainInfo = ({item}) => {
  ...
  return (<View style={styles.orderMainView}>
            {/* order num info  */}
            ...
            {/* course and city  */}
            {showCourceAndCity && <View style={styles.courseAndCityView}>
