...
class ChatSettingsView extends TypedBaseComponent<ChatSettings>{
    ...
    render(){
        ...
        const visibleStyle = this.model.isVisible ? styles.container : styles.hidden
        return <View style={visibleStyle}>
            <View style={styles.mainContent}>
                <View style={styles.closeModalView}>
                    <TouchableOpacity onPress={this.model.hide}>
                        <View style={styles.closeModalBtn}>
                            <Image source={CHAT_ICONS.closeWhite} style={styles.closeIcon}/>
                        </View>
                    </TouchableOpacity>
                </View>
                <View>
                ...
                <View style={styles.concatContainer}>
                    ...
                    <View style={styles.containerTextAnimation}>
                        ...
                        />
                        <Text style={styles.membersText}>{`Учасники: ${
                            chat.membersCount
                        }`}</Text>
                    </View>
                </View>
